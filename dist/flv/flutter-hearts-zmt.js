  ...
  class LikeHeart {
    constructor(opt) {
      /**
             ...
             *
             * @param {object}
             * @object.x {number} 起点位置x
             * @object.y {number} 起点位置y
             * @object.endX {number} 结束位置x
             * @object.endY {number} 结束位置y
             ...
             * @object.opacityDis {number} fadeout临界值(默认距离结束位置40)
